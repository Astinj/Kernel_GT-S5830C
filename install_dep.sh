...
sudo apt-get update && sudo apt-get upgrade && sudo apt-get install emdebian-tools \
gnupg flex bison gperf libsdl-dev libesd0-dev libwxgtk2.6-dev build-essential zip \
curl libncurses5-dev zlib1g-dev valgrind qt3-dev-tools ia32-libs;
